...
def seed_location_data(apps, schema_editor):
    ...
    user_locations = {
        "田中太郎": {"latitude": 34.70079, "longitude": 137.40906},  # Near 食堂
        "鈴木花子": {"latitude": 34.70308, "longitude": 137.40754},  # Near 北駐車場
        "佐藤次郎": {"latitude": 34.70084, "longitude": 137.41008},  # Near 図書館
        "高橋美咲": {"latitude": 34.70093, "longitude": 137.40893},  # Near カフェ
        "伊藤健太": {"latitude": 34.716437, "longitude": 137.405312}, # Far away
    }
